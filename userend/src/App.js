...
function App() {
  ...
  return (
      <Switch>
        {/** Redirects to login page. For now we dont need that functionality
          *  @dev Removing Login route
          */}
        <Route path="/" exact>
          <Redirect to="/login" />
        </Route>
        ...
        {/** 
         * @dev This route is to be removed when backend is integrated 
         */
         }
        {/* <Route path="/" exact>
