...
const ViewSubmissionDetails = () => {
  ...
  const changeStatusBackground = () => {
    if(chosenProject.status === "In progress")
      return "primary";
    if(chosenProject.status === "Approved") 
      return "success";
    if(chosenProject.status === "Review Changes") 
      return "warning";
    return "danger";
  }
  return (
    ...
    <div className="container">
      <div className={styles.mainContainer}>
        ...
        <p class={`bg-${changeStatusBackground()} p-2 rounded text-white w-25`}>Status : {chosenProject.status}</p>
